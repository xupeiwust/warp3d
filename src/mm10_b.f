...
c
      type(crystal_props) :: props
      type(crystal_state) :: np1, n
      double precision, dimension(6) :: stress, R1
      double precision, dimension(size_num_hard) :: tt
      double precision, dimension(max_uhard) :: vec1, vec2
c
      integer :: gp
