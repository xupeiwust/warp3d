      subroutine sparse_factor( neqns, xlnz, coefs, diag, iloc, inum,
     &                          itemp, jtemp, link, jloc, c1 )
c
      implicit none
c     
      integer, intent(in) :: neqns, iloc(*), inum(*), xlnz(*)
      integer, intent(inout) :: itemp(*), jtemp(*), link(*), jloc(*)
      double precision, intent(inout) ::  coefs(*), c1(*),  diag(*) 
c
      integer :: neq, loopl, loop, i, ii, j, istop, istart, iend, 
     &           newk, me, ms, nn, kim, lll, kk, ibegin, ifinsh,
     &           mss, ll1, ll2, ll3, ll4, kk2, kk3, kk4, ibegin2, 
     &           ibegin3, ibegin4, kkk, l2, l3, l4, jj, mm, ntimes1,
     &           nt1, nt2, nt3, nt4, nt5, nt6, mtimes, ntimes,
     &           ll5, ll6, ntimes2, ntimes3, ntimes4, ntimes5,
     &           ntimes6, ll, l6, l5, kk5, kk6, kik, isub, ifinsh6,
     &           ifinsh4, ifinsh5, ifinsh3, ifinsh2, ibegin5,
     &           ibegin6
c    
      double precision :: div, div2, div3, div4, div11, div22, div33,
     &                    div44, diagj, div5, div55, div66, diagal,
     &                    div6  
